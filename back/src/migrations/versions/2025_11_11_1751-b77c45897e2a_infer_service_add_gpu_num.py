...
"""
数据库迁移: infer service add  gpu num 
...
- 修订版本: b77c45897e2a
- 基于版本: def28d16b22a
- 创建时间: 2025-11-11 17:51:02.829256
- 迁移描述: infer service add  gpu num 
...
def upgrade():
    ...
    if 'celery_taskmeta' in existing_tables:
        try:
            ...
            print(f"Warning: Failed to drop celery_taskmeta table: {e}")
    ...
    if 'celery_tasksetmeta' in existing_tables:
        try:
            ...
            print(f"Warning: Failed to drop celery_tasksetmeta table: {e}")
